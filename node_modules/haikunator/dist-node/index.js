...
class Haikunator {
  ...
  haikunate(options) {
    ...
    const config = setDefaults(options, this.config); // set tokenChars if tokenHex is set
    ...
    const noun = this._randomElement(this.nouns); // create random token
